...
class Rdf2Vec(Embedding):
    def __init__(self, knowledge_graph: KnowledgeGraph, rdf2vec_config: Union[Dict[str, Any], Rdf2VecConfig]):
        super().__init__()
        ...
        self._transformer = RDF2VecTransformer(vector_size=conf.embedding_size, walkers=[random_walker], sg=conf.sg)
